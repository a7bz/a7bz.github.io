<template>
    <div class="m-empty" :class="{ 'empty-image-outlined': image === 'outlined' }">
        <div class="m-empty-image" :style="imageStyle">
            ...
            <svg v-else-if="image === 'filled'" class="empty-filled" :style="imageStyle" viewBox="0 0 184 152"
            ...
            <svg v-else-if="image === 'outlined'" class="empty-outlined" :style="imageStyle" viewBox="0 0 64 41"
                xmlns="http://www.w3.org/2000/svg">
...
import { useSlotsExist } from '@/scripts/utils'
